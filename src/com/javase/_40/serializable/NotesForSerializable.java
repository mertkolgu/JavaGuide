...
public class NotesForSerializable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        System.out.println(laptopFound.price);  // 10000
        System.out.println(laptopFound.brand);  // null
    }
}

class Laptop implements Serializable {
    int price;
    transient String brand; // transient -> geçici, çabuk
}
...
// Sonradan bu objeleri dosyadan okumak için yaptığımız işleme ise DeSerialization adı verilir.
