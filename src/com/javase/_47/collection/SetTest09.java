...
public class SetTest09 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Setin içinde Go var mı ? : " + set1.contains("Go"));    // false
        System.out.println("Setin içinde Java var mı ? : " + set1.contains("Java"));    // true

        // isEmpty set'in dolu olup olmadığını gösterir. true ya da false döner.
        System.out.println("Set boş mu ? : " + set1.isEmpty()); // false
