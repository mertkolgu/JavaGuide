package com.javase._76.propertyresourcebundle;
...
public class PropertyResourceBundleTest01 {
    ...
    public static void main(String[] args) {
        ...
        ResourceBundle resourceBundle3 = ResourceBundle.getBundle("com.javase._76.propertyresourcebundle.file", new Locale("tr"));
        String msg3 = resourceBundle3.getString("property.key");
        System.out.println(msg3);

        ResourceBundle resourceBundle4 = ResourceBundle.getBundle("com.javase._76.propertyresourcebundle.file", new Locale("en"));
